...
set d_model=128
set exp_name=save_calib_myfyp_frompretrainedmodel_prompttuning_lora_single_ucihar_lr0.01_rank16
set wandb_mode=disabled
set ckpt_path=C:\Users\pslim\DataDrive\Documents\OneDrive\utm_master\research_methodology\fyp\UniTS\checkpoints\ALL_task_myfyp_frompretrainedmodel_prompttuning_lora_single_ucihar_lr0.01_rank16_UniTS_All_ftM_dm128_el3_train_0\ptune_checkpoint.pth

...
wandb_mode=disabled
ckpt_path=training_checkpoints/ALL_task_myfyp_frompretrainedmodel_prompttuning_lora_single_mitbih_lr0.01_rank16_UniTS_All_ftM_dm128_el3_train_0/ptune_checkpoint.pth
random_port=1234

...
model_name="UniTS"
d_model=128
exp_name="myfyp_frompretrainedmodel_x128_prompttuning_single_ucihar_inference_tflite_dq"
wandb_mode="disabled"
...
tflite_path="/home/lps/fyp/UniTS/tflite_models/myfyp_frompretrainedmodel_x128_prompttuning_single_ucihar_dq.tflite"
